<?php
class Application_Model_RemessaCaixaSigcb extends Application_Model_Remessa
{
    ...
    public function geraremessa($params){
        ...
        foreach($detalhe as $detalhe_boleto){
            ...
            'especie' => \Cnab\Especie::CEF_DUPLICATA_MERCANTIL, // Você pode consultar as especies Cnab\Especie::CEF_OUTROS, futuramente poderemos ter uma tabela na documentação
            'aceite' => 'N', // "S" ou "N"
            'registrado' => true,
