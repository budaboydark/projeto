...
class Especie
{
    ...
    //BRADESCO
    const BRADESCO_CHEQUE = 1;
    const BRADESCO_DUPLICATA_MERCANTIL = 2;
    const BRADESCO_DUPLICATA_DE_SERVICO = 4;
    ...
    // União.
    //Para carteira 12 (moeda variável) pode ser usado: 02 – Duplicata Mercantil, 04 – Duplicata de Serviço,
    // 07 – Letra de Câmbio, 12 – Nota Promissória, 17 – Recibo e 19 – Nota de Débito.
    //Para carteira 15 (prêmio de // seguro) pode ser usado: 16 – Nota de Seguro e 20 – Apólice de Seguro. Para carteira 11/17 modalidade
